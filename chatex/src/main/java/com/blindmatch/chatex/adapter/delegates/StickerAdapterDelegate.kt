 ...
 */
class StickerAdapterDelegate(val viewType: Int, listener: MediaAdapterListener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder {
        return StickerMediaViewHolder(
            parent.inflate(
                R.layout.element_sticker
            )
        )
    }
    ...
    override fun onBindViewHolder(
        ...
        val viewHolder: StickerMediaViewHolder = holder as StickerMediaViewHolder
        viewHolder.itemView.gifView.loadChatexImage(messageData.mediaLink)
    }

}

class StickerMediaViewHolder(iv: View):RecyclerView.ViewHolder(iv)